    ...
    {:else if stats}
      ...
      <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
        ...
        <Card variant="filled" padding="md" class="kpi-card relative overflow-hidden">
          ...
          <span class="kpi-label text-secondary">Total Requests</span>
          <span class="kpi-value text-primary font-bold">{formatNumber(stats.total_requests)}</span>
        ...
        <Card variant="filled" padding="md" class="kpi-card relative overflow-hidden">
          ...
          <span class="kpi-label text-secondary">Success Rate</span>
          <span class="kpi-value text-primary font-bold">{stats.success_rate.toFixed(2)}%</span>
        ...
        <Card variant="filled" padding="md" class="kpi-card relative overflow-hidden">
          ...
          <span class="kpi-label text-secondary">Average Latency</span>
          <span class="kpi-value text-primary font-bold">{stats.avg_latency_ms.toFixed(0)}ms</span>
        ...
        <Card variant="filled" padding="md" class="kpi-card relative overflow-hidden">
          ...
          <span class="kpi-label text-secondary">Tokens Volume</span>
          <span class="kpi-value text-primary font-bold">{formatNumber(stats.total_tokens)}</span>
      ...
      <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
        ...
        <Card variant="filled" padding="sm" class="overview-item">
          <Clock size={16} class="text-[#f97316]" />
        ...
        <!-- Active Tenants -->
        <Card variant="filled" padding="sm" class="overview-item">
          <Users size={16} class="text-[#f97316]" />
          <div class="flex flex-col text-left">
        ...
        <!-- Model Pools -->
        <Card variant="filled" padding="sm" class="overview-item">
          <Database size={16} class="text-[#f97316]" />
          <div class="flex flex-col text-left">
        ...
        <!-- Credentials Health -->
        <Card variant="filled" padding="sm" class="overview-item">
          <KeyRound size={16} class="text-[#f97316]" />
          <div class="flex flex-col text-left">
      ...
      <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <!-- SVG Chart Column (takes 2/3 width on wide screens) -->
        ...
        <!-- Breakdown List Column (takes 1/3 width) -->
